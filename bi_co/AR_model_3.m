...
% General parameters
T0 = 450;  % No. of samples in time (we pretend that each sample is 1 ms)
burn_in = 10; % No. of samples to be discarded at the beginning of a simulation

SNR = 10; % Signal to noise ratio (y)
LCR = 1;  % Local signal to cross-talk ratio
split = 0.1;  % split=0 (only signals from c1)
