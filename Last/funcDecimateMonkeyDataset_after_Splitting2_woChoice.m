function funcDecimateMonkeyDataset_after_Splitting2_woChoice(filenameIN, type_trial, Decim, PAR)
...
window_name ={'baseline_sig'; 'abs_sig'; 'delay_1_sig' ; 'conc_sig' ; 'delay_2_sig' ;'trail_sig'};
load(filenameIN)
if exist('PAR','var')
